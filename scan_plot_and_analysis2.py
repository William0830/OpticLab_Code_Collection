...
def plot_int_heatmap(Xs, Ys, channel_ints, size=(6, 6), save=False, save_name='scan.png'):
    ...
    plot = ax.pcolormesh(Xs, Ys, channel_ints, cmap='viridis', shading='auto')
    ax.set_aspect('equal')
...
def plot_positions_and_error(Xs,Ys, res, xlim = (0, 100), ylim = (0, 100), ticks = 2):
    ...
    plot = ax[1].pcolormesh(Xs, Ys, total_error, cmap='Spectral', shading='auto')
